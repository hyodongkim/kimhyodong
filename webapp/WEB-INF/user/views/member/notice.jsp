                ...
                <div>
                    ...
                    <table class="table">
                        ...
                        <c:forEach var="hp_Notice" items="${hp_notice_list}">
                          <tr>
                              <td id="t1">${hp_Notice.notice_Index}</td>
                              <td id="t2"><a href="/user/views/member/notice_in?notice_Index=${hp_Notice.notice_Index}">${hp_Notice.notice_Title}</a></td>
                              <td id="t3"><fmt:formatDate value="${hp_Notice.notice_Date}" pattern="yyyy년 MM월 dd일"/>
                              <td id="t4">${hp_Notice.notice_Count}</td>
                          </tr>
                        </c:forEach>
                    </table>
                </div>
